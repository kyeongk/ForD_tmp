...
<div class="row">
    <div class="col-md-6 col-md-offset-3">
    	<h1 class="footerTitle">문의하기 - FAQ</h1>
	                ...
	                <c:forEach items="${list }" var="board">
	                	<li>
	                		...
	                		<div class='adminContent'>
	                			<article class='contentArticle'><c:out value="${board.content }"/></article>
	                		</div>
	                	</li>
	                </c:forEach>
        ...
        <p class='qnaText'>목록에 없는 문의사항이나 건의사항이 있으신가요?  <a class='qnaLink' href="https://forms.gle/U4MrREY3K38Lb2Uu6" target="_blank">문의/건의하기</a></p>
    </div>
</div>
