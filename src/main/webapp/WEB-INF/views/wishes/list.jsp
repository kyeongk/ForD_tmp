...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 wListHeaderDiv">
        <h1 class="page-header listHeader">시청예정
        </h1>
        <a class='wListOrder'>정렬하기 <i class="fas fa-chevron-down"></i></a>
		<ul class="dropdown-menu wListOrderUl">
			<li><a href="/wishes/list?order=title">가나다순</a></li>
			<li><a href="/wishes/list?order=date">최근방영순</a></li>
			<li><a href="/wishes/list">랜덤정렬</a></li>
		</ul>
...
<form id='actionForm' action="/wishes/list" method="get">
